...
@Service
public class CreatePayoutDelegate(private val service: PayoutService) {
    public fun invoke(request: CreatePayoutRequest): CreatePayoutResponse {
        val payout = service.payout(request.accountId, PaymentMethodProvider.valueOf(request.paymentMethodProvider))
